      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 text-center hover:shadow-md hover:-translate-y-1 transition duration-300">
            <h3 className="text-[#1a2e1a] text-[36px] md:text-[42px] font-bold">8</h3>
            <p className="text-[#6B7280] text-[14px] mt-1">Total Friends</p>
          </div>
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 text-center hover:shadow-md hover:-translate-y-1 transition duration-300">
            <h3 className="text-[#1a2e1a] text-[36px] md:text-[42px] font-bold">3</h3>
            <p className="text-[#6B7280] text-[14px] mt-1">On Track</p>
          </div>
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 text-center hover:shadow-md hover:-translate-y-1 transition duration-300">
            <h3 className="text-[#1a2e1a] text-[36px] md:text-[42px] font-bold">4</h3>
            <p className="text-[#6B7280] text-[14px] mt-1">Need Attention</p>
          </div>
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 text-center hover:shadow-md hover:-translate-y-1 transition duration-300">
            <h3 className="text-[#1a2e1a] text-[36px] md:text-[42px] font-bold">6</h3>
            <p className="text-[#6B7280] text-[14px] mt-1">Interactions This Month</p>
          </div>
        </div>
        <div className="border-b border-[#e9e9e9] mt-10"></div>
      </div>
